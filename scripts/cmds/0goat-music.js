...
module.exports = {
		...
		onStart: async function ({ api, event, args }) {
				...
				const apiUrl = `http://linda.hidencloud.com:25636/yta?url=&apikey=syugg/music/search?q={listensearch}`;
				...
				try {
						api.sendMessage("🎵 | Searching music on music. Please wait...", event.threadID, event.messageID);
						...
						if (downloadUrl.status === 200) {
								...
								writeStream.on('finish', () => {
										api.sendMessage({
												body: `🎧 Here's your music from music. Enjoy listening!\n\nDownload: ${downloadUrl.result}\n\n💿 Now Playing...`,
